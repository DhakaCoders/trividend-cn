      ...
      <div class="col-md-12">
        <div class="tvd-diensten-sec-inr clearfix">
          <div class="tvd-diensten-lft">
            ...
            <div class="tvd-diensten-img inline-bg" style="background: url('<?php if( !empty($intro['afbeelding']) ) echo cbv_get_image_src($intro['afbeelding'], 'dienstintro'); ?>');">
              <?php if( !empty($intro['afbeelding']) ) echo cbv_get_image_tag($intro['afbeelding'], 'dienstintro'); ?>
            </div>
          </div>
          <div class="tvd-diensten-rgt">
            <?php 
              if( !empty($intro['titel']) ) printf('<h2 class="tvd-diensten-title fl-h1 hide-sm">%s</h2>', $intro['titel']);
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="Our-services-cntlr">
            ...
            <?php 
              $fc_dienstIDs = $diensten['selecteer_diensten'];
                ...
                <div class="our-services-grids">
                  <div class="our-services-grd-item">
                    <div class="osgi-img-cntlr">
                      ...
                      <div class="osgi-img inline-bg" style="background-image: url('<?php echo $gridurl; ?>');"></div>
                    </div>
                    <div class="osgi-desc-cntlr">
                      <h3 class="osgi-desc-title fl-h3 mHc"><a href="<?php the_permalink( ); ?>"><span>01.</span> <?php the_title(); ?></a></h3>
          ...
          <div class="tvd-deinsten-con-sec-inr">
            ...
            <div class="dfp-corona-module">
              <div class="dfp-corona-module-inr">
                <?php 
                  if( !empty($cta['titel']) ) printf('<h2 class="corona-module-title fl-h2">%s</h2>', $cta['titel']);
                  if( !empty($cta['beschrijving'])) echo wpautop($cta['beschrijving']); 
                  $ctpknop = $cta['knop'];
                  if( is_array( $ctpknop ) &&  !empty( $ctpknop['url'] ) ){
                      printf('<a href="%s" target="%s">%s</a>', $ctpknop['url'], $ctpknop['target'], $ctpknop['title']); 
                  }
                ?>
              </div>
            </div>
